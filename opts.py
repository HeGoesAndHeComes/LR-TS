...
parser.add_argument("--model", default="ltrs", help='model type')
...
parser.add_argument("--epochs", type=int, default=60)#50
parser.add_argument("--warmup_epochs", type=int, default=10)
parser.add_argument("--workers", type=int, default= 1)#30
...
parser.add_argument("--checkpoint", default="50", help='ckpt file')

#LR-TS specific parameters
